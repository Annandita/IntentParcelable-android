    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Anandita Fitriani Pratama");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 18);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Anandita Fitriani Pratama");
                mPerson.setAge(18);
                mPerson.setEmail("ananditafitriani@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "085710261043";
